 ...
 */
import type { TranscriptionStatusStatus } from './transcriptionStatusStatus';
import type { TranscriptionResult } from './transcriptionResult';

export interface TranscriptionStatus {
  task_id?: string;
  status?: TranscriptionStatusStatus;
  created_at?: string;
  completed_at?: string;
